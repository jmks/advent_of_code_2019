defmodule Day09Test do
  ...
  test "new features" do
    assert intcode_output_after_halt([104, 1_125_899_906_842_624, 99], []) == [
             1_125_899_906_842_624
           ]

    [sixteen_digit_number] =
      intcode_output_after_halt([1102, 34_915_192, 34_915_192, 7, 4, 7, 99, 0], [])
    ...
    assert intcode_output_after_halt(AdventOfCode2019.read_line_of_cs_ints("09"), [1]) == [
             3_429_606_717
           ]
